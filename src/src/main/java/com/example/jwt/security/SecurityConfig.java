...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(HttpMethod.POST, "/users").hasAnyAuthority("Member", "Admin" +
                "");
        http.authorizeRequests().antMatchers(HttpMethod.GET, "/users").hasAnyAuthority("Member", "Admin", "External");
